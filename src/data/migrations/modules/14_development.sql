...
(v_mod_id, '14.1. Пути развития C++ разработчика', 'C++ — огромный язык, и никто не знает его на 100%. Выберите свою "нишу" и углубляйтесь в неё:
...
Каждая сфера требует своих библиотек/фреймворков (Qt, Boost, RadioLib, OpenCV, DirectX), но база языка везде одна.', 1);
